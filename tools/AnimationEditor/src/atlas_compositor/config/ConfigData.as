package atlas_compositor.config
{
	public class ConfigData
	{
		...
		public function ConfigData(data:Object = null, path:String = "")
		{
			...
			_sourcePath = data["src"] == null ? "" : data["src"];
		...
		private var _listBitmaps:Vector.<TextureBitmapData> = null;
		public function get listBitmaps():Vector.<TextureBitmapData>
		{
			return _listBitmaps;
		}
		
		public function set listBitmaps(value:Vector.<TextureBitmapData>):void
		{
			_listBitmaps = value;
		}
